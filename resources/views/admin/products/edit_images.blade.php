        ...
        <div class="col-xl-12 col-md-12 mb-4 p-4 bg-white">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                <form action="{{route('admin.products.images.destroy',['product'=>$product->id])}}"
                                    ...
                                    <button type="submit" class="btn btn-danger  mb-3">حذف</button>
                                </form>
                                ...
                                <form action="{{route('admin.products.images.set_primary',['product'=>$product->id])}}"
                                    ...
                                    @method('put')
                                    <input type="hidden" name="image_id" value="{{$image->id}}">
                                    <button type="submit" class="btn btn-primary my-2">انتخاب به عنوان تصویر اصلی
                                    </button>
                                </form>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <form action="{{route('admin.products.images.add',['product'=>$product->id])}}" method="post"
                    ...
                    <button class="btn btn-outline-info my-5 px-5" type="submit">ویرایش</button>
                    <a href="{{ route('admin.products.index') }}" class="btn btn-dark my-5 mr-3">بازگشت</a>
                </form>
            </div>
        </div>
