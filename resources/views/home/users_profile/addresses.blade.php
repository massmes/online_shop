                                        ...
                                        @foreach($addresses as $address)
                                            <div>
                                                <address>
                                                    <p class="d-block">
                                                        کاربر :
                                                        <strong> {{ auth()->user()->name == null ? 'نامی وارد نشده' : auth()->user()->name }} </strong>
                                                    </p>
                                                    <p>
                                                    ...
                                                    <p>
                                                        ...
                                                        <span class="d-block mt-1">
                                                            استان : {{ province_name($address->province_id) }}
                                                        </span>
                                                        <span class="d-block mt-1">
                                                            شهر : {{ city_name($address->city_id) }}
                                                        </span>
                                                    </p>
                                                    <p>
                                                        کدپستی :
                                                ...
                                                <a data-toggle="collapse" href="#collapse-address{{$address->id}}"
                                                   class="check-btn btn btn-outline-light text-dark sqr-btn my-2 font-weight-bolder">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="tax-select col-lg-6 col-md-6">
                                                                ...
                                                                <select class="email s-email s-wid province-select"
                                                                    ...
                                                                    @foreach($provinces as $province)
                                                                        <option
                                                                            value="{{$province->id}}" {{$province->id == $address->province_id ? 'selected' : ''}}>
                                                                            {{$province->name}}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <div class="tax-select col-lg-6 col-md-6">
                                                                ...
                                                                <select class="email s-email s-wid city-select"
                                                                        name="city_id">
                                                                    <option
                                                                        value="{{$address->city_id}}" selected>
