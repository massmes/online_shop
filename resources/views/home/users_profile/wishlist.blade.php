                                        ...
                                        <div class="review-wrapper">
                                            @if($wishlist->isEmpty())
                                                <div class="alert alert-danger">
                                                    <p class="text-right">
                                                        متاسفانه به لیست علاقه مندیهای شما محصولی اضافه نشده است
                                                    </p>
                                                </div>
                                            @else
                                                <div class="table-content table-responsive cart-table-content">
                                                    <table>
                                                        ...
                                                        @foreach($wishlist as $item)
                                                            <tr>
                                                                <td class="product-thumbnail p-1">
                                                                    <a href="{{route('home.products.show',['product'=>$item->product->slug,'brand'=>$item->product->brand->slug])}}">
