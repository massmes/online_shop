    ...
    <div class="about-story-area pt-100 pb-100" style="direction: rtl;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="story-img">
                        <a href="#"><img src="{{ asset('images/home/about_us.jpg') }}" alt="about_us"></a>
                    </div>
                </div>
                <div class="col-lg-6 text-right">
                    <div class="story-details pl-50">
                        <div class="story-details-top">
                            <h2> خوش آمدید به <span><b>سپنتا</b> گالری</span></h2>
                            <p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-4">
                    <div class="single-feature text-right mb-40 mt-40 pl-50">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4">
                    <div class="single-feature text-right mb-40 mt-40">
                        <div class="feature-icon">
    ...
    <div class="banner-area pt-100 pb-65">
        <div class="container">
            <div class="row">
                ...
                @foreach($bottomBanners as $bannerBottom)

                    <div class="col-lg-6 col-md-6 text-right">
                        <div class="single-banner mb-30 scroll-zoom">
                            <img src="{{asset(env('BANNER_IMAGES_UPLOAD_PATH').$bannerBottom->image)}}"
