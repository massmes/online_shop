...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'variation_values' => 'دست بندی و ویژگیهای محصول',
        'variation_values.value.0' => 'نام زیر گروه دسته بندی',
        'variation_values.price.0' => 'قیمت',
        'variation_values.quantity.0' => 'تعداد',
        'variation_values.sku.0' => 'شناسه انبار',
        'attribute_ids.*' => 'گزینه های دسته بندی',
    ...
    'your_rule_name' => [
        ...
        'variation_values' => 'required|دسته بندی و ویژگی‌های محصول الزامی است',
        'variation_values.value.0' => 'required|نام زیرگروه دسته بندی الزامی است',
        'variation_values.price.0' => 'required|قیمت الزامی است',
        'variation_values.quantity.0' => 'required|تعداد الزامی است',
        'variation_values.sku.0' => 'required|شناسه انبار الزامی است',
        'attribute_ids.*' => 'required|گزینه‌های دسته بندی الزامی هستند',
        'delivery_amount' => 'required|هزینه ارسال الزامی است'
    ],
